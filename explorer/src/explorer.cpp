...
//                              negotiation = true;
                    ...
                    if(frontier_selection == 2 || frontier_selection == 3 || frontier_selection == 4 || frontier_selection == 0 )
                    {
                        while(true)
                        {
                            goal_determined = exploration->determine_goal(strategy, &final_goal, count, 0, &robot_str);
