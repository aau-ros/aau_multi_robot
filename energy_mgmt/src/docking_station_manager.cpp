...
std::vector<ds_t> DockingStationManager::getDockingStations() {
    ROS_ERROR("invalidation"); //TODO how to handle the fact that iterator can be invalidated?
}

void DockingStationManager::preloadDockingStations()
{
...
void docking::searchNewDockingStations()
{   
...
it->timestamp = ros::Time::now().toSec();
            ...
            if(!already_inserted) {
                ...
                it->has_EOs = true;
                ; //TODO and update DS graph
            
            }
}

void DockingStationDetector::getDockingStationIterator() {
    ROS_ERROR("invalidation"); //TODO how to handle the fact that iterator can be invalidated?
}
